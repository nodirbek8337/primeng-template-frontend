...
import { ExampleTableComponent } from '../table-example/example-table.component';

export default [
    { path: 'example-datatable', data: { breadcrumb: 'Prime Datatable' }, component: ExampleTableComponent },
